...
class TournamentController:
    ...
    def create_tournament(self) -> None:
        ...
        if excluded_player:
            TournamentView.show_message(
                f"Attention : "
                f"{excluded_player.full_name()} "
                f"n'a pas été inscrit car le nombre "
                f"de participants était impair."
            )
    ...
    def start_round(self) -> None:
        ...
        index = TournamentView.select_tournament(
            self.tournaments
        )
        ...
        if not tournament.has_even_number_of_players():
            ...
            TournamentView.show_message(
                f"Attention : "
                f"{excluded_player.full_name()} "
                f"a été retiré du tournoi car "
                f"le nombre de joueurs était impair."
            )
        ...
        tournament.update_scores_snapshot()
